...
<html lang="en">
    ...
    <%!
    	boolean login=false;
    	userDAO userBuy = new userDAO();
    	private ArrayList<userDTO> user_dtos;
    	private ArrayList<buyDTO> buy_dtos;
    	int index[]= new int[4];
    %>
        ...
        <div class="container">
           	<div class="row" >
                ...
                <div class="col-lg-8">
                    ...
                    <form action="buy_action.jsp" method="post">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card mb-4"> 
                                <div class="card-body">
                                     ...
                                     <colgroup>
										...
										<%
											user_dtos=userBuy.getUserBuy(currentPage,ID);
                    						for(int i=0;i<user_dtos.size();i++){
                    						
										%>
										<tr>
											<td><input type=checkbox name="low" value="<%=user_dtos.get(i).getNum()%>"></td>
											<td><%=((currentPage-1)*5)+i+1%></td>
											<td><%=user_dtos.get(i).getName()%></td>
											<td><%=user_dtos.get(i).getPrice()%></td>
										</tr>
										<%
                    						}
										%>						
									...
									<div>
									<input type=submit name="buy" value="구매" > <input type=submit name="buy" value="장바구니에서 삭제">
                                	</div>
                                </div>
                            </div>              
                        </div>
                    ...
                    <nav aria-label="Pagination">
                        ...
                        <ul class="pagination justify-content-center my-4">
                            <%
                        		if(currentPagi>0){
                        	%>
                        		<li class="page-item"><a class="page-link" href="./buy.jsp?pagi_Num=<%=currentPagi-1%>" tabindex="-1" aria-disabled="true"><</a></li>
                        	<%
                        		} else {
                        	%>
                            ...
                            %>
                            <li class="page-item active" aria-current="page"><a class="page-link" href="./buy.jsp?pagi_Num=<%=currentPagi%>&pageNum=<%=i%>"><%=i%></a></li>
                           	<%
                           			if(i%5==0){
                    					break;
                    				}
                            ...
                            %>
                            <li class="page-item"><a class="page-link" href="./buy.jsp?pagi_Num=<%=currentPagi+1%>&pageNum=<%=1+((currentPagi+1)*5)%>">></a></li>
                        	<% 
                            	}
                        	%>
                        </ul>
