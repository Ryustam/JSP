...
<html lang="en">
	...
	int count=0;
	count=userBuy.getBuyListCount(ID);
                            ...
                            <div class="card mb-4"> 
                                <div class="card-body">
                                     ...
                                     <colgroup>
										...
										<%
											buyList_dtos=userBuy.getBuyList(currentPage,ID);
                    						for(int i=0;i<buyList_dtos.size();i++){
                    						
										%>
										<tr>
											<td><%=buyList_dtos.get(i).getNum()%></td>
											<td><%=buyList_dtos.get(i).getDate()%></td>
											<td><%=buyList_dtos.get(i).getName()%></td>
											<td><%=buyList_dtos.get(i).getPrice()%></td>
										</tr>
										<%
                    						}
										%>						
                    ...
                    <nav aria-label="Pagination">
                        ...
                        <ul class="pagination justify-content-center my-4">
                            <%
                        		if(currentPagi>0){
                        	%>
                        		<li class="page-item"><a class="page-link" href="./buyList.jsp?pagi_Num=<%=currentPagi-1%>" tabindex="-1" aria-disabled="true"><</a></li>
                        	<%
                        		} else {
                        	%>
                            ...
                            %>
                            <li class="page-item active" aria-current="page"><a class="page-link" href="./buyList.jsp?pagi_Num=<%=currentPagi%>&pageNum=<%=i%>"><%=i%></a></li>
                           	<%
                           			if(i%5==0){
                    					break;
                    				}
                            ...
                            %>
                            <li class="page-item"><a class="page-link" href="./buyList.jsp?pagi_Num=<%=currentPagi+1%>&pageNum=<%=1+((currentPagi+1)*5)%>">></a></li>
                        	<% 
                            	}
                        	%>
                        </ul>
